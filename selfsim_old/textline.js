...
class TextPane{
  constructor(input_text, x_location, y_location, line_height, offset, font='Courier New'){
    ...
    for (let i = 0; i < this.total_lines; i++){
      ...
      this.graphs.push(new DataLine(this.sim_lines[i], x_location, i*(line_height+offset)+y_location+10,this.w, 3*offset/4, this.sim_min, this.sim_max))
      this.boxes.push(new InterTextLine(this.intertext_lines[i], x_location, i*(line_height+offset)+y_location-10,this.w, line_height/2, i*this.chars_per_line, (i*this.chars_per_line)+this.chars_per_line))
      this.chapters.push(new ChapterAnnotations(this.chapter_annotations[i], x_location,i*(line_height+offset)+y_location-20,this.w, i*this.chars_per_line, (i*this.chars_per_line)+this.chars_per_line))
    }
  ...
  reload_lines(text_location=false){
    ...
    for (let i = new_index; i < this.total_lines+new_index; i++){
      ...
      this.graphs.push(
        new DataLine(this.sim_lines[i], this.x, (i-new_index)*(this.line_height+this.offset)+first_y+10,this.w, 3*this.offset/4, this.sim_min, this.sim_max))
      this.boxes.push(new InterTextLine(this.intertext_lines[i], this.x, (i-new_index)* (this.line_height+this.offset)+first_y-10,this.w, this.line_height/2, i*this.chars_per_line, (i*this.chars_per_line)+this.chars_per_line))
      
      this.chapters.push(new ChapterAnnotations(this.chapter_annotations[i], this.x,(i-new_index)*(this.line_height+this.offset)+first_y-20,this.w, i*this.chars_per_line, (i*this.chars_per_line)+this.chars_per_line))
...
{    this.lines.forEach((line) =>{
  ...
  update(location_delta){
    ...
    while (last_y < height){
      ...
      this.graphs.push(
        new DataLine(this.sim_lines[this.last_loaded_line], this.x, last_y + this.line_height+this.offset+10,this.w, 3*this.offset/4, this.sim_min, this.sim_max)
      )
      
      this.boxes.push(new InterTextLine(this.intertext_lines[this.last_loaded_line], this.x, last_y+ this.line_height+this.offset-10,this.w, this.line_height/2, this.last_loaded_line*this.chars_per_line, (this.last_loaded_line*this.chars_per_line)+this.chars_per_line))

      this.chapters.push(new ChapterAnnotations(this.chapter_annotations[this.last_loaded_line], this.x,last_y+ (this.line_height+this.offset)-20,this.w, this.last_loaded_line*this.chars_per_line, (this.last_loaded_line*this.chars_per_line)+this.chars_per_line))
    ...
    while (this.lines[0].v.y >= -(this.line_height+this.offset) && this.first_loaded_line > 0 && location_delta > 0) {
      ...
      this.graphs.unshift(new DataLine(this.sim_lines[this.first_loaded_line], this.x, this.lines[0].v.y - (this.line_height+this.offset)+10,this.w, this.line_height, this.sim_min, this.sim_max))
      
      this.boxes.unshift(new InterTextLine(this.intertext_lines[this.first_loaded_line], this.x, this.lines[0].v.y -(this.line_height+this.offset)-10,this.w, this.line_height/2, this.first_loaded_line*this.chars_per_line, (this.first_loaded_line*this.chars_per_line)+this.chars_per_line))
      this.chapters.unshift(new ChapterAnnotations(this.chapter_annotations[this.first_loaded_line], this.x,this.lines[0].v.y+ (this.line_height+this.offset)-20,this.w, this.first_loaded_line*this.chars_per_line, (this.first_loaded_line*this.chars_per_line)+this.chars_per_line))
